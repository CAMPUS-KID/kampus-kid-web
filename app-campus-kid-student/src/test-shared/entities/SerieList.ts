import { ListingSerieResponse } from 'src/shared/services/SerieService/types';
export const mockSerieListing: ListingSerieResponse[] = [
  {
    page: 1,
    results: [
      {
      ...
      },
      {
        ...
        popularity: 1887.805,
        poster_path: '/emuCvPY9ztbTM4ct4zqEQXraZli.jpg',
        vote_average: 8.2,
        vote_count: 780
      },
      {
