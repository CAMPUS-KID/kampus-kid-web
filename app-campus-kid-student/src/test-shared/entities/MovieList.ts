import { ListingMovieResponse } from 'src/shared/services/MovieService/types';
export const mockMovieListing: ListingMovieResponse[] = [
  {
    page: 1,
    results: [
      {
      ...
      },
      {
        ...
        popularity: 1520.694,
        poster_path: '/3sQggeZUOte6JGMWIhO8BxlcjQh.jpg',
        release_date: '2022-01-28',
        title: 'The Fallout',
        video: false,
        vote_average: 7.6,
